...
<head>
    ...
    <title>Dashboard Admin - Beranda</title>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div style="margin: 0 30px">
                <h2 style="color: #0092FF">Hello Admin!</h2>
                <p>Suzuran All-Boys High School AKA The Crows School. It's reputation even roars in other prefectures as the most notorious delinquent school. Usually Suzuran is divided into many factions which over the years have included the Umehoshi-Gumi, GPS, Bandou Faction, Harumichi Family, Hideyoshi Faction, Butcher Faction (FBI), Hana-Gumi and Tetsuwan Family.</p>
                <p>It's said that Suzuran is full of kids that could easily be the leaders of other schools, but no one could ever unite it.</p>
            </div>
        </div>
    </div>
    </div>
