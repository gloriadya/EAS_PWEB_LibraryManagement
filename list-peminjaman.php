...
<head>
    ...
    <title>Dashboard Admin - Data Orang Tua Murid</title>
    ...
    <div class="wrapper">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="<?php if(basename($_SERVER['SCRIPT_NAME']) == 'list-orangtua.php'){echo 'active'; }else { echo ''; } ?>">
                    <a href="list-peminjaman.php">Data Peminjaman Buku</a>
                </li>
        ...
        <div id="content">
            ...
            <button class="btn btn-success" style="float: right" data-toggle="modal" data-target="#myModal">Tambah Data</button>
                <h2 style="color: #0092FF">Daftar Guru</h2>
                ...
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $sql2 = "SELECT * FROM guru LIMIT $halaman_awal, $batas";
                            $query2 = mysqli_query($db, $sql2);

                            $nomor = $halaman_awal + 1;

                            while ($guru = mysqli_fetch_array($query2)) {
                                echo "<tr>";

                                echo "<td>".$nomor++."</td>";
                                echo "<td>".($guru['fotodiri'] == null ? "" : "<img src='uploads/guru/" . $guru['fotodiri'] . "' width='120' height='160'>")."</td>";
                                echo "<td>".$guru['nama']."</td>";
                                echo "<td>".$guru['mata_pelajaran']."</td>";
                                echo "<td>".$guru['nomor_hp']."</td>";
                                echo "<td>".$guru['nip']."</td>";

                                echo "<td>";
                                echo "<button class='btn btn-warning' style='margin-bottom: 5px' onclick=window.location.href='form-edit-guru.php?id_guru=".$guru['id_guru']."'>Edit</button>";
                                echo "<br />";
                                echo "<button class='btn btn-danger' onclick=window.location.href='hapus.php?id_guru=".$guru['id_guru']."'>Hapus</button>";
                                echo "</td>";
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title font-weight-bold">Form Input Data Guru</h4>
                    ...
                    <form action="proses_tambah.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <button style="float: right;" class="btn btn-success submit" type="submit" name="tambah_guru" value="tambah_guru">Tambah</button>
                            </div>
                        </div>
                    </form>
                </div>
